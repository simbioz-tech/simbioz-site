...
export default function PrivacyPolicy() {
    ...
    return (
        <>
            <Helmet>
                <title>Политика конфиденциальности — Симбиоз</title>
                <meta name="description" content="Политика конфиденциальности Симбиоз: как мы обрабатываем и защищаем ваши персональные данные, права пользователя, сроки хранения, контакты." />
            </Helmet>
            <Page>
